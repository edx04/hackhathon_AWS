...
exports.CreateOutboundConnectionCommand = void 0;
...
class CreateOutboundConnectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.CreateOutboundConnectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.CreateOutboundConnectionResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1CreateOutboundConnectionCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1CreateOutboundConnectionCommand(output, context);
    }
}
exports.CreateOutboundConnectionCommand = CreateOutboundConnectionCommand;
//# sourceMappingURL=CreateOutboundConnectionCommand.js.map