...
class CreatePackageCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.CreatePackageRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.CreatePackageResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1CreatePackageCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1CreatePackageCommand(output, context);
    }
}
exports.CreatePackageCommand = CreatePackageCommand;
//# sourceMappingURL=CreatePackageCommand.js.map