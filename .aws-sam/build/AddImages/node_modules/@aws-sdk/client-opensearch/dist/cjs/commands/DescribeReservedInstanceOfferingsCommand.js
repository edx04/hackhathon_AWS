...
exports.DescribeReservedInstanceOfferingsCommand = void 0;
...
class DescribeReservedInstanceOfferingsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeReservedInstanceOfferingsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DescribeReservedInstanceOfferingsResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1DescribeReservedInstanceOfferingsCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1DescribeReservedInstanceOfferingsCommand(output, context);
    }
}
exports.DescribeReservedInstanceOfferingsCommand = DescribeReservedInstanceOfferingsCommand;
//# sourceMappingURL=DescribeReservedInstanceOfferingsCommand.js.map