...
exports.AcceptInboundConnectionCommand = void 0;
...
class AcceptInboundConnectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.AcceptInboundConnectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.AcceptInboundConnectionResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1AcceptInboundConnectionCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1AcceptInboundConnectionCommand(output, context);
    }
}
exports.AcceptInboundConnectionCommand = AcceptInboundConnectionCommand;
//# sourceMappingURL=AcceptInboundConnectionCommand.js.map